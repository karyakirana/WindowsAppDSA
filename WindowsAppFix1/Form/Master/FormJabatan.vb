Public Class FormJabatan
    ...
    Private Async Sub store()
        ...
        Dim jabatan As Jabatan = New Jabatan With {
            .nama = CStr(namaTextEdit.EditValue),
            .keterangan = CStr(keteranganTextEdit.EditValue)
        }
    ...
    Public Async Sub edit(ByVal id As Long)
        ...
        If Not getData Is Nothing Then
            ...
            namaTextEdit.EditValue = jabatan.nama
            keteranganTextEdit.EditValue = jabatan.keterangan
            _update = True
        End If
    End Sub
