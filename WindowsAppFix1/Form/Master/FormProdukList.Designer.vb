...
Partial Class FormProdukList
    ...
    Private Sub InitializeComponent()
        ...
        Me.colproduk_image.Visible = True
        Me.colproduk_image.VisibleIndex = 16
        '
        'colproduk_kategori
        '
        ...
        Me.colproduk_kategori.VisibleIndex = 17
        '
        ...
        Me.colproduk_kemasan_beli.Visible = True
        Me.colproduk_kemasan_beli.VisibleIndex = 18
        '
        'FormProdukList
        '
