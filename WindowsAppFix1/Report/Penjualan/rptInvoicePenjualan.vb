...
Public Class rptInvoicePenjualan
    ...
    Private Sub rptInvoicePenjualan_BeforePrint(sender As Object, e As CancelEventArgs) Handles Me.BeforePrint
        XrLabel5.Text = Terbilang(Convert.ToInt32(totalBayar)) & "Rupiah"
    End Sub

    Private Sub rptInvoicePenjualan_AfterPrint(sender As Object, e As EventArgs) Handles Me.AfterPrint
