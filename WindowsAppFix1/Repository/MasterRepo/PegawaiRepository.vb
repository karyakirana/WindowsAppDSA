...
Public Class PegawaiRepository
    ...
    Public Async Function GetList() As Task(Of List(Of Pegawai))
        _response = Await _client.GetAsync("master/pegawai")
        ...
        If _response.IsSuccessStatusCode Then
            ...
            Return _jObject("data").ToObject(Of List(Of Pegawai))
        End If
    ...
    Public Async Function Store(pegawai As Pegawai) As Task(Of Boolean)

        Dim json = JsonConvert.SerializeObject(pegawai)
        Dim content As New StringContent(json, Encoding.UTF8, "application/json")
        _response = Await _client.PostAsync("master/pegawai", content)
    ...
    Public Async Function Update(pegawai As Pegawai) As Task(Of Boolean)

        Dim json = JsonConvert.SerializeObject(pegawai)
        Dim content As New StringContent(json, Encoding.UTF8, "application/json")
        _response = Await _client.PutAsync("master/pegawai", content)
    ...
    Public Async Function delete(ByVal id As Long) As Task(Of Boolean)
        ...
        _response = Await _client.DeleteAsync("master/pegawai/" & id)
