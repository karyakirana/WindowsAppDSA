...
Public Class PersediaanRepo
    ...
    Public Async Function GetList() As Task(Of List(Of Persediaan))
        _response = Await _client.GetAsync("persediaan")
        ...
        If _response.IsSuccessStatusCode Then
            ...
            Return _jObject("data").ToObject(Of List(Of Persediaan))
        End If
